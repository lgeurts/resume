...
This resume is based on a CV template from [Christoph Berger](https://github.com/darwiin/yaac-another-awesome-cv). It uses the Source Sans Pro Font from Adobe and a selection of Font Awesome icons to highlight important elements.
