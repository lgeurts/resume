...
\cvlistdoubleitem{Microsoft Azure Compute: Infrastructure as a Service (IaaS) Workshop} {Vital Signs: Performance Monitoring Windows Server Workshop}

\section{Courses}
\cvlistdoubleitem{Windows Internals for Escalation Engineers} {Mandel: Presentation Skills for Technical Professionals}
\cvlistdoubleitem{Crucial Conversations: Tools for Talking When Stakes Are High} {Accelerated Windows Memory Dump Amalysis}
